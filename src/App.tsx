    ...
    <div className="min-h-screen p-2.5 font-sans" style={{ overflowX: 'hidden' }}>
      ...
      <div className="text-center mt-4 pt-2.5 border-t border-gray-200">
        ...
        <div className="inline-flex items-center gap-1.5">
          ...
          <a href="https://github.com/guicol57/electrification-score" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 no-underline text-[9px] text-gray-500 hover:text-gray-700">
